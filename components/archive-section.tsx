        ...
        <div className="space-y-12">
          {sections.map((section, sectionIndex) => (
            <div
              key={section.id}
              className={cn(
                "border border-border bg-card/50 backdrop-blur-sm rounded-lg overflow-hidden transition-all duration-1000 shadow-2xl",
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8",
              )}
            ...
            >
              ...
              <div className="bg-secondary/50 border-b border-border px-4 py-2 flex items-center gap-2">
                ...
                <div className="flex-1 text-center font-mono text-xs text-muted-foreground opacity-70 flex items-center justify-center gap-2">
